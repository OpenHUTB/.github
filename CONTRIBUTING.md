...
1.如果提交 Pull Request 时出现冲突，则参考 [使用 TortoiseGit 解决冲突](./docs/resolve_conflict.md) 或 [在 GitHub 上解决合并冲突](https://docs.github.com/zh/pull-requests/collaborating-with-pull-requests/addressing-merge-conflicts/resolving-a-merge-conflict-on-github) 。
