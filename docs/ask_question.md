...
现在开源（Open Source）软件已经相当盛行，您通常可以从其他更有经验的用户那里获得好的答案，这是件好事；用户们往往对那些新手常遇到的问题更宽容一些。尽管如此，以我们在此推荐的方式对待这些有经验的用户通常也是从他们那里获得有用答案的最有效方式。
...
如果你厌恶开源社区的态度，高高在上，或过于傲慢，不妨也设身处地想想。开源社区并没有要求你向社区屈服 —— 事实上，开源社区大多数人非常乐意与你平等地交流，只要你付出小小努力来满足基本要求，开源社区就会欢迎你加入社区的文化。但让开源社区帮助那些不愿意帮助自己的人是没有效率的。无懂没有关系，但装不懂就是不行。
